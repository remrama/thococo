...
ax.xaxis.set(major_locator=plt.MultipleLocator(0.5), minor_locator=plt.MultipleLocator(0.1))
ax.yaxis.set(major_locator=plt.MultipleLocator(0.05), minor_locator=plt.MultipleLocator(0.01))
